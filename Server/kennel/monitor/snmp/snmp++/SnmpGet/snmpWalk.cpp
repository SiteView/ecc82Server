...
/*
  ...
  Peter E. Mellquist
*/
char snmpwalk_cpp_version[]="@(#) SNMP++ $Id: snmpWalk.cpp 264 2006-06-16 20:53:15Z fock $";
...
int main(int argc, char **argv)
{
  ...
  int objects  = 0;
   ...
   Oid oid("1.3.6.1.2.1.1.1.0");                      // default is beginning of MIB 
   ...
   */
   ...
   cout << "传入的oid:" << oid.get_printable() <<endl;
   ...
   cout << "pdu中vb个数：" << pdu.get_vb_count() << endl;
