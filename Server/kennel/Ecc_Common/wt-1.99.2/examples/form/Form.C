...
void Form::addValidationStatus(int row, WFormWidget *edit)
{
  WImage *imageInvalid = new WImage("icons/invalid.png");
  WImage *imageInvalidEmpty = new WImage("icons/invalid.png");
  elementAt(row, 1)->addWidget
    (new WValidationStatus(edit, 0, imageInvalid, imageInvalidEmpty));
}
...
void Form::createUI()
{
  ...
  addValidationStatus(row, nameEdit_);
  ...
  addValidationStatus(row, countryEdit_);
  ...
  addValidationStatus(row, birthDateEdit_);
  ...
  addValidationStatus(row, childCountEdit_);
  ...
  elementAt(2, 1)->resize(WLength(20), WLength());
}
