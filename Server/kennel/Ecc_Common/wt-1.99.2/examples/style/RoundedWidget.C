...
void RoundedWidget::create()
{
  ...
  top_->resize(WLength(), WLength(radius_));
  if (images_[1])
  ...
  impl_->insertWidget(top_, contents_); // insert top before the contents
  ...
  bottom_->resize(WLength(), WLength(radius_));
  if (images_[3])
...
{
  if (images_[0]) images_[0]->setRadius(radius_);
  if (images_[1]) images_[1]->setRadius(radius_);
  if (images_[2]) images_[2]->setRadius(radius_);
  if (images_[3]) images_[3]->setRadius(radius_);

  if (images_[0]) images_[0]->setForeground(backgroundColor_);
  if (images_[1]) images_[1]->setForeground(backgroundColor_);
  if (images_[2]) images_[2]->setForeground(backgroundColor_);
  if (images_[3]) images_[3]->setForeground(backgroundColor_);
