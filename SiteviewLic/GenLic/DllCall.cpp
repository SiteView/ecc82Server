...
{
//	return CreateLicense(srcData) == 1;
...
bool CDllCall::GetOldLic(const char* fileName, LICENSEDATA* licData)
{
	...
	//else
	//{//
	//	Decrypt2Data(items[0].c_str(), licData);
	//}
	return Decrypt2Data((char*)inBuff, licData);
}
/*

bool CDllCall::Encrypt2Str(const LICENSEDATA& srcData, char* dest)
{
...
{	
	return ::Decrypt2Data(srcStr, dstData);
}
/*
