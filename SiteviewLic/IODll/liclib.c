...
#ifdef WIN32
				//if (ReadDataDirFromSysReg("SOFTWARE\\SiteView",licData.ProductName,reg_guid))
				if (ReadDataDirFromSysReg("SOFTWARE\\SiteView","SiteviewECC",reg_guid))
				{
...
// 从License数据创建License文件
DLLEXPORT 	int CreateLicenseFileNew(const char* filename, LICENSEDATA licData)
{
	char data[20485] = {0};
	char endata[10240] = {0};
